// config-default.h: Default configuration for flui.
...
/*
 * This file specifies the default settings for flui.
 *
...
// Uncomment for flashlight firmware 1 "Ramp 2C" behavior:
//   - Ramp 2C goes to turbo (advanced UI) or ceiling (simple UI), like in flashlight firmware 1
// Or comment out to use flashlight firmware 2 behavior instead:
...
//#define DEFAULT_2C_STYLE 2  // default to flashlight firmware 2 style
