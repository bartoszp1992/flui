// BLF Q8 config options for flui using the Attiny1616
...
#include "wurkkos/flui.h"  // Sofirn lights are closely related to Wurkkos
...
// also at Sofirn's request, enable 2 click turbo (flashlight firmware 1 style)
