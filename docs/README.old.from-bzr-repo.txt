...
For Windows / MacOS users, these links may be useful:
  ...
  Oweban's guides:  (Windows 10, MacOS X) (not generic, focuses on flui)
...
working.
  ...
  - Make sure you're using gcc-avr 1:5.4.0+Atmel3.6.2 or newer.
    ...
    /usr/lib/gcc/avr/5.4.0/../../../avr/bin/ld: address 0x80381e of flui.elf section `.data' is not within region `data'
